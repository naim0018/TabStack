                ...
                {activeReminders.length > 0 ? (
                  activeReminders.map((reminder) => (
                    <GlassContainer
                      ...
                      className="group flex items-center gap-4 p-4 !rounded-xl bg-white/5 border-white/5 hover:border-accent/20 hover:bg-white/10 transition-all cursor-pointer"
            ...
            <div className="flex flex-wrap gap-3">
              {topSites.slice(0, 10).map((site, idx) => (
                <GlassContainer
                  ...
                  className="relative group/site p-0 overflow-visible"
                >
                  <a
                    href={site.url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-accent/5 transition-all max-w-[200px]"
                    title={site.title}
                  >
                    <img
...
const PlanCard = ({
  ...
  return (
    <GlassContainer
      ...
      className={`group relative p-4 !rounded-xl transition-all cursor-pointer overflow-hidden ${
        isCompleted
